        ...
        >
          ...
          <blockquote class="relative p-8 mb-4">
            ...
            <p class="text-md font-light mt-2 text-white">
              Transformamos tus ideas en realidad digital con una experiencia de
              usuario excepcional, backend robusto y gestión segura de datos.
              Únete a nosotros.
            </p>
          </blockquote>
        </div>
